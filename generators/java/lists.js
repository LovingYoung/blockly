...
Blockly.Java['lists_repeat'] = function(block) {
  ...
  var functionName = Blockly.Java.provideFunction_(
    ...
    '(value, n) {',
      ...
      '  return array;',
      '}']);
  var element = Blockly.Java.valueToCode(block, 'ITEM',
      Blockly.Java.ORDER_COMMA) || 'null';
  var repeatCount = Blockly.Java.valueToCode(block, 'NUM',
...
Blockly.Java['lists_setIndex'] = function(block) {
  ...
  switch (where) {
    ...
    case ('FROM_START'):
      ...
      break;
    case ('FROM_END'):
      var at = Blockly.Java.getAdjusted(block, 'AT', 1, false,
 ...
 */
Blockly.Java.lists.getIndex_ = function(listName, where, opt_at) {
  if (where == 'FIRST') {
    return '0';
...
Blockly.Java['lists_getSublist'] = function(block) {
  ...
  if (where1 == 'FIRST' && where2 == 'LAST') {
    ...
    var getIndex_ = Blockly.Java.lists.getIndex_;
...
Blockly.Java['lists_split'] = function(block) {
  ...
  var input = Blockly.Java.valueToCode(block, 'INPUT',
    Blockly.Java.ORDER_MEMBER);
  var delimiter = Blockly.Java.valueToCode(block, 'DELIM',
      Blockly.Java.ORDER_NONE) || '\'\'';
