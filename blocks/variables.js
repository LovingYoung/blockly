...
Blockly.Block['variables_get'] = {
  init: function(){
    this.initJSON({"extensions": ["contextMenu_variableSetterGetter"]});
    this.appendField(new Blockly.FieldVariable(), "VAR");
    this.setOutput(true, null);
    this.setColor("%{BKY_VARIABLES_HUE}");
    this.setHelpUrl("%{BKY_VARIABLES_GET_HELPURL}");
    this.setToolTip("%{BKY_VARIABLES_GET_TOOLTIP}");
  }
};
